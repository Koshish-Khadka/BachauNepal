...
const Filter = () => {
  ...
  return (
    <div className="absolute top-4 right-2 z-[9999]">
      ...
      {isOpen && (
        <div>
          <div className="absolute top-10 right-10 bg-white p-4 rounded shadow-lg w-64 rounded-md">
            <h3 className="text-sm font-normal mb-2">Map type</h3>

            <div className="flex justify-between mt-4">
              <div className="space-y-2">
                <Image alt="Image" src={image} width={50} height={80} className="rounded-lg"/>
                <p>Satellite</p>
              </div>
              <div className="space-y-2">
                <Image alt="Image" src={image} width={50} height={80} className="rounded-lg"/>
